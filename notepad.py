...
class NotePad:
    ...
    def __init__(self, **kwargs):
        ...
        try:
            self.__root.wm_iconbitmap(
                r'C:\Users\sarjaisw\Desktop\python\pythonProjects\icon\py.png')
        except:
            pass

        # set window size (the dfault is 300 x 300)
        try:
        ...
        # scrollbar will adjust atomatically according to the content
    ...
    def __showAbout(self):
        showinfo('Notepad', 'Sarita Jaiswal')

    def __openFile(self):
        self.__file = askopenfilename(defaultextension='.txt', filetypes=[(
            'All Files', '*.*'), ('Text Documents', '*.txt'), ('pdf Documents', '*.pdf')])
